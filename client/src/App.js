...
import FavoriesMovies from "./Screens/Dashboard/FavoriesMovies";
...
function App() {
  ...
  const { isError } = useSelector((state) => state.userLikeMovie);
  ...
  }, [dispatch, userInfo, isError, catError]);
  return (
    <>
      <ToasterContainer />
      <DrawerContext>
        <ScrollOnTop>
          <Routes>
            ...
            <Route path="/movies/genre/:genre" element={<MPByGenre />} />
            ...
            <Route element={<ProtectedRouter />}>
              ...
              <Route path="/favorites" element={<FavoriesMovies />} />
              {/* *****************ADMIN ROUTES *************** */}
